...
<!-- task-count-badge -->![Tasks](https://img.shields.io/badge/tasks-85-orange)<!-- /task-count-badge -->
...
<!-- task-count-text -->PinchBench includes 85 tasks across real-world categories:<!-- /task-count-text -->
